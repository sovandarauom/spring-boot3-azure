...
import com.newbie.springboot3azure.exception.CustomAccessDeniedHandler;
import com.newbie.springboot3azure.exception.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public MapReactiveUserDetailsService userDetailsService() {
        ...
        UserDetails admin = User.builder()
                ...
                .username("springboot3azureadmin")
                .roles("ADMIN")
                .build();
